...
@HiltViewModel
internal class InitialLanguageViewModel @Inject constructor(
    private val sharePreferencesManager: SharePreferencesManager
) : BaseViewModel<InitialLanguageViewModel.ViewState, InitialLanguageViewModel.Action>(ViewState()) {
    ...
    fun save() {
        ...
        sharePreferencesManager.initialLanguage = true
    }
