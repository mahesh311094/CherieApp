...
import com.ar7lab.cherieapp.databinding.FragmentStorePastSaleBinding
 ...
 * */
@AndroidEntryPoint
class StorePastSaleFragment : BaseFragment(R.layout.fragment_store_past_sale) {

    //View binding of fragment_market
    private val binding: FragmentStorePastSaleBinding by viewBinding()

    //Initialize StoreUpcoming Deals ViewModel
    private val viewModel: StorePastSaleViewModel by viewModels()
    ...
    private val stateObserver = Observer<StorePastSaleViewModel.ViewState> { state ->
        ...
        binding.rvItems.withModels {
            ...
            arts.forEachIndexed { index, art ->
                itemStorePastSaleSeeAll {
                    ...
                    listener(object : StorePastSaleArtListener {
