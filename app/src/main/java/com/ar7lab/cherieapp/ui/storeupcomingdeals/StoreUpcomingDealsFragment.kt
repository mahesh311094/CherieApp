...
import com.ar7lab.cherieapp.databinding.FragmentStoreUpcomingDealsBinding
 ...
 * */
@AndroidEntryPoint
class StoreUpcomingDealsFragment : BaseFragment(R.layout.fragment_store_upcoming_deals) {

    //View binding of fragment_market
    private val binding: FragmentStoreUpcomingDealsBinding by viewBinding()

    //Initialize StoreUpcoming Deals ViewModel
    private val viewModel: StoreUpcomingDealsViewModel by viewModels()
    ...
    private val stateObserver = Observer<StoreUpcomingDealsViewModel.ViewState> { state ->
    ...
    private fun createEpoxyRecyclerView() {
        binding.rvItems.withModels {
            ...
            itemUpcomingDealsTitle {
                id("upcoming deals")
                spanSizeOverride { _, _, _ -> 2 }
            }
            arts.forEachIndexed { index, art ->
                itemStoreUpcomingDealsSeeAll {
                    ...
                    listener(object : StoreUpcomingDealsArtListener {
                        override fun onClick(art: Art) {
                            ...
                            val action = StoreUpcomingDealsFragmentDirections.actionStoreToTraditionalArtworkDetails(art)
