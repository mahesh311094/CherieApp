...
import com.ar7lab.cherieapp.databinding.ActivityMarketTraditionalArtBinding
...
import com.ar7lab.cherieapp.ui.market.ArtTransactionListener
...
@AndroidEntryPoint
class TradingArtActivity : BaseActivity() {

    private val binding: ActivityMarketTraditionalArtBinding by viewBinding()
    ...
    private fun addClickEvent() {
        ...
        binding.btnBuy.setOnClickListener {
            //val modalBottomSheet = BuyBottomSheetFragment()
            //modalBottomSheet.show(supportFragmentManager, BuyBottomSheetFragment.TAG)
        }
        //on sell button clicked
        binding.btnSell.setOnClickListener {
            //val modalBottomSheet = SellBottomSheetFragment()
            //modalBottomSheet.show(supportFragmentManager, SellBottomSheetFragment.TAG)
        }
    }
}