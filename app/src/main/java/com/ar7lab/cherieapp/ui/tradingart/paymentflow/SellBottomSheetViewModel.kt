...
@HiltViewModel
internal class SellBottomSheetViewModel @Inject constructor(
    private val sharePreferencesManager: SharePreferencesManager,
    private val walletRepository: WalletRepository,
) : BaseViewModel<SellBottomSheetViewModel.ViewState, SellBottomSheetViewModel.Action>(ViewState()) {
