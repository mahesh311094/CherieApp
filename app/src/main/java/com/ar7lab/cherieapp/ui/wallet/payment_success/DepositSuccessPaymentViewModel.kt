...
@HiltViewModel
internal class DepositSuccessPaymentViewModel @Inject constructor(
    private val paymentRepository: PaymentRepository,
    private val sharePreferencesManager: SharePreferencesManager
) : BaseViewModel<DepositSuccessPaymentViewModel.ViewState, DepositSuccessPaymentViewModel.Action>(
    ViewState()
){
