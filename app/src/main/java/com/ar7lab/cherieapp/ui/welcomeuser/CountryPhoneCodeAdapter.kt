...
/**
 * Country phone code adapter for get country dropdown
 * @property simple_spinner_dropdown_item is the xml file
 * */
class CountryPhoneCodeAdapter(context: Context, private var mCountryCodes: List<Country>) :
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        holder.tvName?.text = "${getItem(position).name} (${getItem(position).phone}) "
